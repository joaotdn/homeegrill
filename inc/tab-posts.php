      ...
      <div class="row">
        <div class="small-12 columns">
          ...
          <ul class="inline-list tab-options">
            ...
            <li>
              <h4 class="font-large"><a href="#" class="d-block silver text-low" title="">receitas</a></h4>
            </li>

            <li>
              <h4 class="font-large"><a href="#" class="d-block silver text-low" title="">projetos de decoração</a></h4>
            </li>

            <li>
              <h4 class="font-large"><a href="#" class="d-block silver text-low" title="">institucional</a></h4>
            </li>
          </ul>
          ...
          <div class="small-12 left showroom-controls">
            <ul class="inline-list no-margin">
              ...
              <li>
                <h5 class="text-low"><a href="#" title="Ver todas as churrasqueiras">Ver todos os posts</a></h5>
              </li>
            </ul>
          </div>
        </div><!-- coluna -->
