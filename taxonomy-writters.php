<?php
  ...
  <div class="row">
    ...
    <header class="small-12 columns post-header">
      <h2 class="no-margin lh-normal text-low">Rubens Maia</h2>
      ...
      <nav id="nav-posts" class="small-12 left" role="navigation">
        ...
        <div class="small-12 medium-6 columns">
          ...
          <a href="#" class="d-block small-12 left author-link">
            ...
            <span class="small-2 left hide-for-tiny show-for-large-up d-block full-height">
              <span class="go-post d-table small-12">
