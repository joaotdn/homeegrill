  ...
  <div class="row">
    ...
    <section id="blog-content" class="small-12 left data-panel">
      ...
      <header class="small-12 columns post-header">
        <h2 class="no-margin lh-normal text-low">Assistência técnica</h2>
      ...
      <section class="small-12 columns">
        <nav id="shop-list" class="small-12 left">
          ...
          <!-- loja -->
          <div class="shop-item small-12 left" data-state="Paraíba">

            <figure class="shop-front small-12 medium-8 right shop-info sale-point">
            ...
            <div class="small-12 medium-4 right shop-info bg-white rel sale-point">
              <hgroup class="small-12">
                <div class="divide-20"></div>
                <h4 class="no-margin">Paraíba Service</h4>
                <h5 class="divide-10 font-lite">João Pessoa - PB</h5>
                <h6 class="font-lite font-medium">(83) 9999 3333</h6>
                <h6 class="font-lite font-medium">Rua Dr. Manoel Lopes de Carvalho, 962, Loja 966, Centro.</h6>
              </hgroup>
            </div>
          ...
          <!-- loja -->
          <div class="shop-item small-12 left" data-state="Bahia">
            ...
            <div class="small-12 medium-4 right shop-info bg-white rel sale-point">
              <hgroup class="small-12">
                <div class="divide-20"></div>
                <h4 class="no-margin">Salvador Service</h4>
                <h5 class="divide-10 font-lite">João Pessoa - PB</h5>
                <h6 class="font-lite font-medium">(83) 9999 3333</h6>
                <h6 class="font-lite font-medium">Rua Dr. Manoel Lopes de Carvalho, 962, Loja 966, Centro.</h6>
              </hgroup>
          ...
          <!-- loja -->
          <div class="shop-item small-12 left" data-state="Pernambuco">
            ...
            <div class="small-12 medium-4 right shop-info bg-white rel sale-point">
              <hgroup class="small-12">
                <div class="divide-20"></div>
                <h4 class="no-margin">Pernambuco Service</h4>
                <h5 class="divide-10 font-lite">João Pessoa - PB</h5>
                <h6 class="font-lite font-medium">(83) 9999 3333</h6>
                <h6 class="font-lite font-medium">Rua Dr. Manoel Lopes de Carvalho, 962, Loja 966, Centro.</h6>
              </hgroup>
