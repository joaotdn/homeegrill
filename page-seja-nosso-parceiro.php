    ...
    <div class="row">
      ...
      <article class="small-12 medium-8 large-8 left">
        ...
        <header class="small-12 columns post-header">
          <h2 class="no-margin lh-normal">seja nosso parceiro</h2>
        ...
        <article class="small-12 left">
          ...
          <h5 class="divide-40 columns">Estreite o relacionamento com a home & GRILL e seja nosso parceiro.</h5>  
          <h5 class="font-lite divide-40 columns">Se interessa em ser revendedor da nossa marca? Este é o espaço para você informar para a gente quais são suas pretenções. É só preencher o formulário abaixo:</h5>
          ...
          <form action="">
            <header class="divide-30 columns">
              <h5 class="no-margin">Dados do responsável:</h5>
            </header>
            ...
            <div data-abide class="small-12 left">       
              ...
              <div class="small-12 left">
                ...
                <div class="small-12 medium-6 columns form-field">
                  ...
                  <small class="error small-12 columns">Obrigatório</small>
                  <div class="divide-20"></div> 
                </div>
              ...
              <header class="divide-30 columns">
                <h5 class="no-margin">Informações da empresa que deseja ser parceira:</h5>
              </header>
              ...
              <div class="small-12 left"> 
                ...
                <div class="small-12 medium-6 columns form-field">
                  <input type="text" placeholder="Ramo de atividade" required pattern="[a-zA-Z]+">
                  <small class="error small-12 columns">Obrigatório (apenas letras)</small>
                  <div class="divide-20"></div> 
                </div>
              </div> <!-- //row -->
              ...
              <div class="small-12 left">
                <div class="small-12 medium-6 columns form-field">
                  <input type="text" placeholder="Cidade" required pattern="[a-zA-Z]+">
                  <small class="error small-12 columns">Obrigatório (apenas letras)</small>
                  <div class="divide-20"></div> 
                </div>
              ...
              <div class="small-12 left">
                <div class="small-12 columns form-field">
                  <input type="text" placeholder="CNPJ" required pattern="number" class="mk-cnpj" maxlength="14">
                  <small class="error small-12 columns">Obrigatório (cnpj inválido)</small>
                  <div class="divide-20"></div> 
                </div>
              </div><!-- // row -->
