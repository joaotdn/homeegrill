    ...
    <div class="row">
      ...
      <article class="small-12 medium-8 large-8 left">
        ...
        <header class="small-12 columns post-header">
          <h2 class="no-margin lh-normal">Fale conosco</h2>
        ...
        <article class="small-12 left">
          ...
          <h5 class="divide-40 columns">Entre em contato agora conosco!</h5>  
          <h5 class="font-lite divide-40 columns">Envie suas dúvidas , sugestões ou críticas. Será uma honra poder lhe atender. Vamos procurar lhe responder o mais breve possível.</h5>
